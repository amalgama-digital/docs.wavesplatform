...
В поле **Order** заполните параметры ордера и нажмите **Sign order**. В MetaMask предоставьте доступ к открытому ключу, затем подтвердите подписание данных. Подпись ордера появится на странице Dapp test в поле **result**.
