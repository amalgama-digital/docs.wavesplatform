...
Получить список и статусы фич можно с помощью метода [GET /activation/status](https://nodes.wavesnodes.com/api-docs/index.html#/activation/getFeatureStatuses) [REST API ноды](/ru/waves-node/node-api/).
...
| 16 | Ride V5, dApp-to-dApp invocations | <br>• Добавлена версия 5 Стандартной библиотеки Ride.<br>• Добавлена возможность вызова dApp из dApp.<br>• Добавлен тип данных `BigInt`<br>Полный список изменений см. в статье [Release Notes](/ru/keep-in-touch/release-notes#версия-1-3-jumeirah) | 2 650 000 | Июнь 2021 |

> \* Высота блокчейна Mainnet в момент активации фичи.

:warning: Следующая фича доступна в версиях ноды 1.4.x, в данный момент только на Stagenet:

| ID Фичи | Название | Описание |
|---|:---:|---|
| 17 | Ride V6, MetaMask support, Invoke Expression | <br>• Добавлена версия 6 Стандартной библиотеки Ride.<br>• Добавлена поддержка транзакций в формате Ethereum, выполняющих перевод токена или вызов dApp-скрипта, и поддержка ордеров с подписью ECDSA в транзакции обмена.<br>• Добавлена транзакция применения выражения.<br>Полный список изменений см. в статье [Release Notes](/ru/keep-in-touch/release-notes) |
