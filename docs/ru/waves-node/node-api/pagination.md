...
Метод [GET /assets/{assetId}/distribution/{height}/limit/{limit}](https://nodes.wavesnodes.com/api-docs/index.html#/assets/getAssetDistribution) возвращает распределение указанного ассета по адресам на блокчейне.
...
Метод [GET /transactions/address/{address}/limit/{limit}](https://nodes.wavesnodes.com/api-docs/index.html#/transactions/getTxsByAddress) возвращает список транзакций с участием указанного адреса.
