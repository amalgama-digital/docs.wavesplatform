...
| :--- | :--- | :--- |
| script | До 32&nbsp;768 байт | [Скрипт аккаунта](/ru/ride/script/script-types/account-script) или [dApp-скрипт](/ru/ride/script/script-types/dapp-script) |
...
| **6.3** | Скрипт | script | Array[[Byte](/ru/blockchain/blockchain/blockchain-data-types)] | `S` | `S` = 0, если значение поля 6.1 равно 0.<br>1 <= `S` <= 32&nbsp;768`, если значение поля 6.1 равно 1 |
