...
| 19 | [Транзакция в формате Ethereum](/ru/blockchain/transaction-type/ethereum-transaction) | Выполняет вызов скрипта или перевод токена от имени пользователя MetaMask |

> Транзакция применения выражения и транзакция в формате Ethereum добавлены в версии ноды 1.4.0. Возможность использовать эти транзакции включается после активации фичи №&nbsp;17 “Ride V6, MetaMask support, Invoke Expression”. Версии 1.4.x в настоящее время доступны только для [Stagenet](/ru/blockchain/blockchain-network/).
