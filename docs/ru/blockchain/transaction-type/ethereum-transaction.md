...
Пользователь MetaMask может подписать и отправить на блокчейн Waves транзакцию в формате Ethereum, которая выполняет вызов dApp-скрипта или перевод токена. [Подробнее о поддержке MetaMask](/ru/keep-in-touch/metamask)
