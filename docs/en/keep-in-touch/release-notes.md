...
* Changed the limitation on the second parameter of `drop`,` dropRight`, `take`,` takeRight` [string functions](/en/ride/v6/functions/built-in-functions/string-functions) and [byte array functions](/en/ride/v6/functions/built-in-functions/byte-array-functions).
