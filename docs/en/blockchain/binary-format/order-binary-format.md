...
| 9 | Amount of milliseconds from the beginning of [Unix epoch](https://en.wikipedia.org/wiki/Unix_time) till the moment of validation of order by matcher | timestamp | [Long](/en/blockchain/blockchain/blockchain-data-types) | 8 | bytes in [big-endian](https://en.wikipedia.org/wiki/Endianness) notation |
