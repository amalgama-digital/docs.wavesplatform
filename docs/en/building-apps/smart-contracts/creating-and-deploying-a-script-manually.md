...
2. We want to set up a script for a [generated](https://nodes.wavesnodes.com/api-docs/index.html#/addresses/createWalletAddress) account in order to implement the **smart account **idea.
